#Создаем массив,вводим в него данные
<?php
$stext=[
    'title'=>'<h3>Первый заголовок статьи</h3>',
        'body'=>'<p> Описание для статьи, чтобы рассказать о чем будет в статье в кратце. Здесь абсолютно комфортно вы можете генерировать тексты-«рыбы» для решения задач в области макетирования.
                      <br>
    ...
    'title2'=>'<h3>Второй заголовок для статьи</h3>',
    'body2'=>'<p>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                        <?php
                        # В нужном месте html подключаем цикл foreach
