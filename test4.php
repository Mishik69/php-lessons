        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    $img=[
                       [
                           'source'=>'img/demo/gallery/21.jpg',
                           'thumb'=>'img/demo/gallery/thumb/21.jpg',
                       ],
                        [
                            'source'=>'img/demo/gallery/22.jpg',
                            'thumb'=>'img/demo/gallery/thumb/22.jpg',
                        ],
                        [
                            'source'=>'img/demo/gallery/23.jpg',
                            'thumb'=>'img/demo/gallery/thumb/23.jpg',
                        ],
                        [
                            'source'=>'img/demo/gallery/24.jpg',
                            'thumb'=>'img/demo/gallery/thumb/24.jpg',
                        ],
                        [
                            'source'=>'img/demo/gallery/25.jpg',
                    ...
                    <div id="js-lightgallery">
                        ...
                        <a class="" href="<?php echo $im['source'];?>">
                            <img class="img-responsive" src="<?php echo $im['thumb'];?>" alt="image">
                            <?php endforeach;?>
                        </a>
                    </div>
                </div>
